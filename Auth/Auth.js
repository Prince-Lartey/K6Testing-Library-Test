...
export default function main() {
  ...
  group('page_1 - https://svelte-library-auth-3-0.vercel.app/', function () {
    ...
    response = http.post(
      ...
      '{"firstName":"Emmanuel","lastName":"Example","email":"emma@example.com","password":"5Kgtbu30"}',
      {
        headers: {
    ...
    response = http.get('https://node-library-spg2.onrender.com/api/v1/books', {
      headers: {
        accept: 'application/json, text/plain, */*',
        authorization:
          'Bearer eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJ1c2VySWQiOiI2NTU2MjUxNzJlMDRkMWJlMzU5NjUzM2IiLCJmaXJzdE5hbWUiOiJFbW1hbnVlbCIsImxhc3ROYW1lIjoiRXhhbXBsZSIsImlhdCI6MTcwMDE0NDQyOCwiZXhwIjoxNzAxODcyNDI4fQ.ANMCbyonaT8yYBpRZyhqf_Us3HjZ72jfLqBDf4Qdm0I',
        referer: 'https://svelte-library-auth-3-0.vercel.app/',
        'user-agent':
          'Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/119.0.0.0 Safari/537.36',
        'sec-ch-ua': '"Google Chrome";v="119", "Chromium";v="119", "Not?A_Brand";v="24"',
